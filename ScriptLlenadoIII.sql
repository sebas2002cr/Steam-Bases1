...
-- Insercion de 12 juegos
-- Insercion de badges y ownspecs para uno de ellos
-- ------------------------------------
...
'www.img.com/gtavlogo', 'www.downloadgtav.com', 1, 4, 2);


-- ------------------------------------------------------------
-- platforms of the games
...
-- ------------------------------------------------------------
-- (12, 10, 29.99, 'USD', 0.20, 0.70, 1, CURRENT_TIMESTAMP(), SHA2(CONCAT(CURRENT_TIMESTAMP(),' ','121.65.18.64',' ','admin12'),256), '121.65.18.64', 'admin12');


-- ------------------------------------------------------------
-- Game specs -- o el ID correspondiente a GTA V
INSERT INTO GameOwnSpecs (`name`, `description`, Gameid) VALUES
('LAUNCH YOUR CRIMINAL EMPIRE', 'Launch business ventures from your Maze Bank West Executive Office', 12),
('A FLEET OF POWERFUL VEHICLES', 'Tear through the streets with a range of 10 high performance vehicles', 12);

-- ------------------------------------------------------------
-- platforms of the game GTA V (12)
INSERT INTO Game_Platforms (Gameid, idPlatformType) VALUES
(12,3),(12,4),(12,5),(12,6);

-- ------------------------------------------------------------
-- badges of the game GTA V (12)
INSERT INTO Badges (`name`, Gameid, iconURL, miniDescription, badge_levelId) VALUES
('Explorer', 12, 'www.img.com/gtav/badge1', 'Discover the whole city. You do not need gps', 2),
('high-class criminal', 12, 'www.img.com/gtav/badge2', 'complete the history mode', 3);


-- ------------------------------------------------------------
-- badges of the game Rocket Leage (8)
INSERT INTO Badges (`name`, Gameid, iconURL, miniDescription, badge_levelId) VALUES
('Bronze', 8, 'www.img.com/rocket/bronze', '10 wins at Bronze Rank or higher', 5),
('Silver', 8, 'www.img.com/rocket/silver', '10 additional wins at Silver Rank or higher', 4),
('Gold', 8, 'www.img.com/rocket/gold', '10 additional wins at Gold Rank or higher', 3),
('Platinum', 8, 'www.img.com/rocket/platinum', '10 additional wins at Platinum Rank or higher', 2),
('Diamond', 8, 'www.img.com/rocket/diamond', '10 additional wins at Diamond Rank or higher', 1);


-- badges of the game Counter-Strike (7)
INSERT INTO Badges (`name`, Gameid, iconURL, miniDescription, badge_levelId) 
VALUES
('Private Rank', 7, 'www.img.com/CSGO/bronze', '0 XP', 5),
('Corporal Rank', 7, 'www.img.com/CSGO/silver', '20,000 XP', 4),
('Sergeant Rank', 7, 'www.img.com/CSGO/gold', '40,000 XP', 3),
('Master Sergeant Rank', 7, 'www.img.com/CSGO/platinum', '75,000 XP', 2),
('Global General Rank', 7, 'www.img.com/CSGO/diamond', '195,000 XP 1);

-- badges of the game Call of Duty: Warzone (6)
INSERT INTO Badges (`name`, Gameid, iconURL, miniDescription, badge_levelId) 
VALUES
('Prestige 1', 6, 'www.img.com/CODwz/bronze', '0 XP', 5),
('Prestige 2', 6, 'www.img.com/CODwz/silver', '20,000 XP', 4),
('Prestige 3', 6, 'www.img.com/CODwzgold', '40,000 XP', 3),
('Prestige 4', 6, 'www.img.com/CODwz/platinum', '75,000 XP', 2),
('Prestige 5', 6, 'www.img.com/CODwz/diamond', '195,000 XP 1);


SELECT * FROM Badges_Levels;
